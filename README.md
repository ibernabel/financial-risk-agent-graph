# **CreditGraph AI: Agentic Risk Assessment System**
...
**CreditGraph AI** is a stateful multi-agent system built to modernize the credit evaluation process in emerging markets (specifically targeting the Dominican Republic's financial sector).

Unlike traditional rule-based automations, CreditGraph AI uses **Cognitive Agents** to analyze unstructured data (bank statements, informal business letters, social media footprints) and calculate a dynamic **Internal Risk Score (IRS)**.
...
The core differentiator of CreditGraph AI is its ability to quantify qualitative data.
...
- **Morality (30%):** 100 - (20 _ financial_alerts) - (10 _ interview_inconsistencies)
...
_AI Solutions Architect | Transforming Financial Operations_
